...
const AreaDetails = () => {
  ...
  const { zone_id, area_id } = useParams();
    ...
    <>
      <div className="px-[30px]">
        <div className="flex gap-x-[10px] mr-[30px] mt-[13px] items-center justify-end">
          ...
          <span>&gt;</span>
          <Link to={"/areas"} className="text-textBlack text-[20px] font-[600]">
            Areas
          </Link>
          <span>&gt;</span>
        ...
        <div className="mt-[21px] flex items-center gap-x-[15px]">
          ...
          />
          <span className="text-[32px] text-textBlackH font-[600]">Areas</span>
        </div>

        <div className="shadow-[0px_1px_8px_0px_rgba(0,0,0,0.08)] bg-textWhite w-full rounded-[16px] py-[16px] px-[25px] mt-[31px] relative">
