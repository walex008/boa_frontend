  ...
  return (
    <>
      <div className="px-[30px]">
        <AddHead prev="Areas" prevLink="areas" current="Details" />

        <div
          className={`shadow-[0px_1px_8px_0px_rgba(0,0,0,0.08)]  w-full h-[370px] md:h-[309px] rounded-[16px] py-[16px] px-[25px] mt-[20px] relative ${
