...
const BranchDetails = () => {
  ...
  const { zone_id, area_id, branch_id } = useParams();
  ...
  return (
    <>
      <div className="px-[30px]">
        <AddHead prev="Branches" prevLink="branches" current="Details" />

        <div
          className={`shadow-[0px_1px_8px_0px_rgba(0,0,0,0.08)]  w-full h-[420px] md:h-[359px] rounded-[16px] py-[16px] px-[25px] mt-[20px] relative ${
        ...
        >
          ...
          <div className="flex flex-col md:flex-row w-full gap-x-[70px]">
            ...
            <div className="w-full md:w-[45%] md:hidden">
              <div className="flex items-center justify-between p-[14px_2px_11px_1px] border-b-[1px] border-b-[#C6CCD2]">
                <p className="text-[0.8125rem] md:text-[1.125rem] text-textGrey font-[600]">
                  Status
                </p>
