...
const LineChart = () => {
  ...
  return (
    <div className="w-full h-full px-[25px]">
      <div className={`h-fit w-full ${darkMode==="true"?"bg-bgSemiBlack":"bg-textWhite"} rounded-[16px] p-[23px] mt-[49px]`}>
        <div className="flex w-full items-center md:gap-x-[121px] justify-between md:justify-normal mb-[43px]">
          ...
          <div className="flex gap-x-[15px] md:gap-x-[30px] items-center">
            <div className="flex items-center">
              ...
              />
              <span className={`text-[0.5rem] md:text-[1.25rem] ${darkMode==="true"?"text-textWhite":"text-textBlackH"} font-[400]`}>
                Expected
              </span>
            </div>
            <div className="flex items-center">
        ...
        <div className="flex flex-col md:flex-row w-full">
          ...
          <div className="w-full md:w-[30%] mt-[25px] md:mt-0 lg:w-[18%] md:ml-[39px] flex flex-row md:flex-col justify-between md:justify-normal gap-y-[18px]">
            <div className="w-[80px] md:w-[142px] h-[44px] md:h-[86px] p-[2px_0px_4.626px_0px] md:p-[13px_0px_11px_0px] rounded-[8px] bg-blueLight shadow-[0px_1px_4px_0px_rgba(0,0,0,0.04)] flex flex-col  items-center justify-center">
              <p className="text-[0.5rem] md:text-[1rem] text-textBlack, font-[600]">Today</p>
              <p className="text-[0.75rem] md:text-[1.5rem] text-textBlackH font-[400]">0.00</p>
              <div className="flex items-center">
                <img
                  src="/images/fall.png"
                  alt=""
                ...
                />{" "}
                <span className="text-[0.375rem] md:text-[0.875rem] text-red font-[400]">34%</span>
              </div>
            </div>
            ...
            <div className="w-[80px] md:w-[142px] h-[44px] md:h-[86px] p-[2px_0px_4.626px_0px] md:p-[13px_0px_11px_0px] rounded-[8px] bg-[#FFFAE5] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.04)] flex flex-col  items-center justify-center">
              ...
              <div className="flex items-center">
                <img
                  ...
                  className="h-[10px] md:h-[16px] w-[10px] md:w-[16px]"
                />
                <span className="text-[0.375rem] md:text-[0.875rem] text-green font-[400]">34%</span>
              </div>
            </div>
          </div>
        </div>
